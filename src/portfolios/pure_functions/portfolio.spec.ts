...
import { positions, positionOpportunity } from '../interfaces/interfaces';
...
describe('Given i have a portfolio with max var allowed is 200  with 1 max open trade per direction per pair', () => {
  it('when i ask if there is an opportunity adding a long BTC/USDT of 100 dollar, the opportunity should be accepted', async () => {
...
describe('Given i have a portfolio with max var allowed is 200  with 1 max open trade per direction per pair', () => {
  it('when i ask if there is an opportunity adding a long ETH/USDT of 100000000 dollar, the opportunity should be rejected', async () => {
    const positionOpportunity: positionOpportunity = {
      pair: 'ETH/USDT',
